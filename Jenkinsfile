...
=======
def jobs = [
	'master':{node('slave3'){masterBranch = 'master'; buildOnBranch(masterBranch)}},
	'stable':{node('slave1'){stableBranch = 'stable'; buildOnBranch(stableBranch)}},
	'process-supervision':{node('slave1'){stableBranch = 'process-supervision'; buildOnBranch(stableBranch)}},
	failFast: false]
>>>>>>> adding process supervision to job list
parallel jobs
